      ...
      <section class="statistics" style="background-image: url('media/carbonCauses.jpg'); background-size: cover;">
        ...
        <div class="row g-4">
          <div class="col-md-4" data-aos="fade-up">
            <div class="stat-card">
              <h3>36.3 GT</h3>
              <p>Global CO2 emissions annually</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="stat-card">
              <h3>419 ppm</h3>
              <p>Current atmospheric CO2 levels</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="stat-card">
              <h3>1.1°C</h3>
              <p>Global temperature rise since 1880</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="row g-4">
          <div class="col-md-6 col-lg-3" data-aos="fade-up">
            <div class="cause-card">
              ...
              <p>Fossil fuel burning accounts for 75% of global emissions</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
            <div class="cause-card">
              ...
              <p>Cars, planes, and ships contribute 24% of emissions</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
            <div class="cause-card">
              ...
              <h4>Industry</h4>
              <p>Manufacturing and production create 21% of emissions</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
            <div class="cause-card">
              ...
              <h4>Agriculture</h4>
              <p>Farming and livestock produce 24% of greenhouse gases</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="timeline" style="background-image: url('media/carbonTimeline.jpg'); background-size: cover;">
        ...
        <div class="timeline-container">
          <div class="timeline-item" data-aos="fade-right">
            ...
            <p>Rising temperatures leading to extreme weather events</p>
          </div>
          <div class="timeline-item" data-aos="fade-left">
            <h4>Ocean Acidification</h4>
            <p>CO2 absorption making oceans 30% more acidic</p>
          </div>
          <div class="timeline-item" data-aos="fade-right">
            <h4>Air Quality</h4>
            <p>Poor air quality causing 7 million premature deaths annually</p>
          </div>
        </div>
      </section>
        ...
        <div class="row g-4">
          <div class="col-md-4" data-aos="fade-up">
            <div class="solution-card">
              ...
              <p>Transitioning to solar, wind, and other clean energy sources</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="solution-card">
              <h4>Electric Vehicles</h4>
              <p>Shifting to zero-emission transportation options</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="solution-card">
              <h4>Carbon Capture</h4>
              <p>Implementing technologies to remove CO2 from the atmosphere</p>
            </div>
          </div>
        </div>
      </section>
