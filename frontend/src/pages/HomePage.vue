        ...
        <div class="card__container__wrapper">
            <div class="card__container">
                <article class="card__article">
                    <img src="/media/Study.jpg" alt="Study" class="card__img">
                    <div class="card__data">
                        <span class="card__description">Educate</span>
